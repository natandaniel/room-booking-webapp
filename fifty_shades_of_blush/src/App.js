        ...
        <div className="mdl-grid portfolio-max-width">
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work01.jpg")} border="0" alt="" />
            </div>
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work07.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work02.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work03.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work04.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work08.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work05.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work06.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
          ...
          <div className="mdl-cell mdl-card mdl-shadow--4dp portfolio-card">
            <div className="mdl-card__media">
              <img className="article-image" src={require("./images/example-work09.jpg")} border="0" alt="" />
            </div>
            <div className="mdl-card__title">
